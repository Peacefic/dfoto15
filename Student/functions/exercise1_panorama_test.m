...
%addpath( genpath( 'C:\Users\Prasanth Korada\Documents\Computational Photography\Student' ) );% Add paths to all subdirectories of the parent directory

REFERENCE_VIEW      = 3;
CAMERAS             = 3;

load('C:\Users\Prasanth Korada\Documents\Computational Photography\Student\debug\part1\points2d.mat');
load('C:\Users\Prasanth Korada\Documents\Computational Photography\Student\debug\part1\norm_mat.mat');
load('C:\Users\Prasanth Korada\Documents\Computational Photography\Student\debug\part1\homographies.mat');
